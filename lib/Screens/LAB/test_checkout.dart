...
class _TestCheckoutState extends State<TestCheckout> {
  ...
  Future initialize() async {
    ...
    controller
        .getTestCheckout(widget.labid, widget.testids, '', widget.relative_id)
        .then((value) {
      setState(() {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount:
                                      checkoutsummary.data.testDtails.length,
